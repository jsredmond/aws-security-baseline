...
class MCPClient:
    ...
    def _call_mcp_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Any:
        ...
        """
        raise NotImplementedError("MCP tool calls must be made through Kiro environment")


class AWSDocsClient(MCPClient):
    """Client for AWS Documentation MCP server"""
    
    def search_documentation(self, search_phrase: str, limit: int = 10) -> List[Dict[str, Any]]:
        """
    ...
    def read_documentation(self, url: str, max_length: int = 5000, start_index: int = 0) -> str:
        """
