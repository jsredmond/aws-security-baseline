        ...
        with open(output_path, "w") as f:
            ...
            for module in summary.modules_audited:
                ...
                for severity in [
                    ...
                    severity_findings = [
                        f for f in module_findings if f.severity == severity
                    ]
                    if severity_findings:
                        ...
                        for finding in severity_findings:
                            ...
                            f.write(
                                f"**Breaking Change:** {'Yes' if finding.breaking_change else 'No'}\n\n"
                            )
                            ...
                            f.write("**References:**\n\n")
                            f.write(
                                f"- [AWS Documentation]({finding.aws_doc_reference})\n"
                            )
                            f.write(
                                f"- [Terraform Documentation]({finding.terraform_doc_reference})\n\n"
                            )
                            f.write("---\n\n")
            ...
            f.write("## Quick Wins\n\n")
            f.write(
                "These findings are low effort but provide significant security value:\n\n"
            )
            ...
            critical_high = self.get_findings_by_severity(
                Severity.CRITICAL
            ...
            if critical_high:
                for finding in critical_high:
                    ...
                    f.write(f"  - Effort: {finding.effort.title()}\n")
                    f.write(
                        f"  - Breaking: {'Yes' if finding.breaking_change else 'No'}\n\n"
                    )
            else:
            ...
            f.write(
                "- [CloudTrail Resource](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudtrail)\n"
            )
            f.write(
                "- [S3 Bucket Resources](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket)\n"
            )
            f.write(
                "- [KMS Key Resource](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/kms_key)\n\n"
            )
