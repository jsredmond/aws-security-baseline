...
from wizard.prompts import select_modules, select_region, select_environment, configure_tags
...
def main(output_path: str = DEFAULT_OUTPUT_PATH) -> int:
    ...
    **Validates: Requirements 10.1, 10.2, 10.3**
    ...
    try:
        ...
        console.print("[dim]Please report this issue at: https://github.com/jsredmond/aws-security-baseline/issues[/dim]")
        return 1
