...
class TerraformModule:
    ...
    def get_resource(self, resource_type: str, resource_name: str) -> Optional[TerraformResource]:
        """Get a specific resource by type and name"""
        for resource in self.resources:
            if resource.resource_type == resource_type and resource.resource_name == resource_name:
                return resource
        return None
...
class TerraformParser:
    ...
    def _extract_resources(self, content: str, file_path: str) -> List[TerraformResource]:
        """
